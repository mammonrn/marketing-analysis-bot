...
⚠️ ตาราง **Lost VIP มีเบอร์โทรลูกค้า** ตามที่ `vip-members.md` ระบุว่ารายชื่อนี้มีไว้ให้ทีม CRM
โทรกลับ เป็นข้อมูลติดต่อชุดเดียวในทั้ง payload และอยู่แค่ตารางนั้นตารางเดียว (ตาราง Top VIP
ไม่มี) ลิงก์ Mini App ใช้ token อายุ 1 ชั่วโมงผูกกับแชทเดียว — **อย่าส่งลิงก์ต่อออกนอกทีม**
